<?php /* Smarty version 2.6.26, created on 2012-10-06 13:36:45
         compiled from /var/www/eccube-2.12.2/html/../data/Smarty/templates/default/shopping/payment.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/var/www/eccube-2.12.2/html/../data/Smarty/templates/default/shopping/payment.tpl', 36, false),array('modifier', 'h', '/var/www/eccube-2.12.2/html/../data/Smarty/templates/default/shopping/payment.tpl', 125, false),array('modifier', 'sfGetErrorColor', '/var/www/eccube-2.12.2/html/../data/Smarty/templates/default/shopping/payment.tpl', 152, false),array('modifier', 'sfGetChecked', '/var/www/eccube-2.12.2/html/../data/Smarty/templates/default/shopping/payment.tpl', 152, false),array('modifier', 'nl2br', '/var/www/eccube-2.12.2/html/../data/Smarty/templates/default/shopping/payment.tpl', 155, false),array('modifier', 'default', '/var/www/eccube-2.12.2/html/../data/Smarty/templates/default/shopping/payment.tpl', 222, false),array('modifier', 'number_format', '/var/www/eccube-2.12.2/html/../data/Smarty/templates/default/shopping/payment.tpl', 244, false),array('function', 'html_options', '/var/www/eccube-2.12.2/html/../data/Smarty/templates/default/shopping/payment.tpl', 223, false),)), $this); ?>
        ...
        <div class="pay_area">
            ...
            <table summary="お支払方法選択" id="payment">
                ...
                <thead>
                    <tr>
                        <th class="alignC">選択</th>
                        <th class="alignC" colspan="<?php if (! ((is_array($_tmp=$this->_tpl_vars['img_show'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>2<?php else: ?>3<?php endif; ?>" id="payment_method">お支払方法</th>
                    </tr>
                </thead>
                <tbody>
                    <?php unset($this->_sections['cnt']);
...
">
        ...
        <?php if (((is_array($_tmp=$this->_tpl_vars['tpl_login'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1 && ((is_array($_tmp=@USE_POINT)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) !== false): ?>
            <div class="point_area">
                <h3>ポイント使用の指定</h3>
                    <p><span class="attention">1ポイントを<?php echo ((is_array($_tmp=((is_array($_tmp=@POINT_VALUE)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
...
円</span> <span class="attention">(送料、手数料を含みません。)</span>
 ...
 onclick="fnCheckInputPoint();" /><label for="point_on">ポイントを使用する</label>
                                <?php $this->assign('key', 'use_point'); ?><br />
                            今回のお買い物で、<input type="text" name="<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
" class="box60" />&nbsp;Ptを使用する。<span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
                            </li>
 ...
 onclick="fnCheckInputPoint();" /><label for="point_off">ポイントを使用しない</label></li>
                        </ul>
                </div>
            </div>
        <?php endif; ?>
