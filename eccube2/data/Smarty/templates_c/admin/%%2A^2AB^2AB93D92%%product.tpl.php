<?php /* Smarty version 2.6.26, created on 2012-10-06 13:38:00
         compiled from products/product.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/product.tpl', 62, false),array('modifier', 'h', 'products/product.tpl', 66, false),array('modifier', 'sfGetErrorColor', 'products/product.tpl', 160, false),array('modifier', 'default', 'products/product.tpl', 211, false),array('modifier', 'function_exists', 'products/product.tpl', 333, false),array('modifier', 'sfNoImageMainList', 'products/product.tpl', 420, false),array('function', 'html_options', 'products/product.tpl', 116, false),array('function', 'html_radios', 'products/product.tpl', 126, false),array('function', 'html_checkboxes', 'products/product.tpl', 132, false),)), $this); ?>
...
<tr>
   <th>comment</th>
     <td>
        <span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr']['comment7'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
        <input type="text" name="comment7" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['comment7'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
" size="60" class="box60" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr']['comment7'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
" />
    </td>
</tr>
	<tr>
