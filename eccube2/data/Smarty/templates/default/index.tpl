...
<!--{assign var=mynum value=1|rand:3}-->
<br />
    <!--{if $mynum == 1}-->
        <a href="<!--{$smarty.const.P_DETAIL_URLPATH}-->1">アイス</a>
    <!--{elseif $mynum == 2}-->
　　    <a href="<!--{$smarty.const.P_DETAIL_URLPATH}-->2">おなべ</a>
    <!--{else}-->
　　    <a href="<!--{$smarty.const.P_DETAIL_URLPATH}-->3">レシピ</a>
    <!--{/if}-->
