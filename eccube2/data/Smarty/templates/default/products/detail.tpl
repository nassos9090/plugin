...
　           <!--{/if}-->
	    ...
	    <strong>無制限</strong>
	    <!--{elseif $arrProduct.stock_min == $arrProduct.stock_max }-->
                ...
                <!--{section name=r loop=$arrRelativeCat}-->
                    <dd>
                        <!--{section name=s loop=$arrRelativeCat[r]}-->
                            <a href="<!--{$smarty.const.ROOT_URLPATH}-->products/list.php?category_id=
                                 <!--{$arrRelativeCat[r][s].category_id}-->"><!--{$arrRelativeCat[r][s].category_name}--></a>
...
<span class="attention"><!--{$arrErr.class}--></span>
...
--></script>
		...
		<tr>
		    ...
		    <td>
		    	...
		    	<input type="radio" id="class" name="class" value="<!--{$arrProductsClassList[i].classcategory_id1}-->_<!--{$arrProductsClassList[i].classcategory_id2}-->">
		    </td>
		    ...
		    <td>
			<!--★価格★-->
		        <!--{$arrProductsClassList[i].price02|sfCalcIncTax
　　　　　　　　　　　　　　　　:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->円
		    </td>
		    <td>
			<!--★在庫数★-->
		　　    <!--{$arrProductsClassList[i].stock}-->個
		    </td>
		</tr>
		<!--{/section}-->
            </table>
	...
	　　<!--▲商品一覧表▲-->
	    <!-------------//商品一覧表追加部分------------->
            ...
            <input type="hidden" id="product_class_id" name="product_class_id" value="<!--{$tpl_product_class_id}-->"/>
                ...
                <div class="cartin">
                    <div class="cartin_btn">
                        <div id="cartbtn_default">
                            <!--★カゴに入れる★-->
                            <a href="javascript:void(document.form1.submit())" onmouseover="chgImg('<!--{$TPL_URLPATH}-->
                                            img/button/btn_cartin_on.jpg','cart');" onmouseout="chgImg('<!--{$TPL_URLPATH}-->
            ...
            <!--{if $smarty.const.OPTION_FAVORITE_PRODUCT == 1 && $tpl_login === true}-->
			   ...
			   onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_add_favorite_on.jpg','add_favorite_product');" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_add_favorite.jpg','add_favorite_product');">
				<img src="<!--{$TPL_URLPATH}-->img/button/btn_add_favorite.jpg" alt="お気に入りに追加" name="add_favorite_product" id="add_favorite_product" /></a>
                    <!--{else}-->
