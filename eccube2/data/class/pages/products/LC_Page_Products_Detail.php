...
class LC_Page_Products_Detail extends LC_Page_Ex {
    ...
    function lfInitParam(&$objFormParam) {
        $objFormParam->addParam('規格1', 'classcategory_id1', INT_LEN, 'n', array());
        $objFormParam->addParam('規格2', 'classcategory_id2', INT_LEN, 'n', array());
        $objFormParam->addParam('規格', 'class', 4, 'n', array('EXIST_CHECK', 'MAX_LENGTH_CHECK'));
